...
public class IfaValue implements Comparable<IfaValue> {

    public static final IfaValue NULL = new IfaValue();
    public static final IfaValue VOID = new IfaValue();
    ...
    public List<IfaValue> asList() {
        return (List<IfaValue>)value;
    }
    ...
    //@Override
    public int compareTo(IfaValue that) {
